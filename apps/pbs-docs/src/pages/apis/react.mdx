...
```ts
BottomSheet: (props: PlainBottomSheetProps) => ReactNode;
```
...
`PlainBottomSheetProps` is the props of `BottomSheet`, and it lets you customize the bottom sheet's style, and behavior.  
