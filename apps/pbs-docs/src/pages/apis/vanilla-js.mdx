...
```ts
createBottomSheet: (props: BottomSheetProps) => BottomSheet;
```
...
`bottomSheet` is the return value of the function `createBottomSheet`. You can interact with the bottom sheet using the `BottomSheet` object.
